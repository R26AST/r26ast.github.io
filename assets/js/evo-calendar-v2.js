!(function (e) {
          ...
          (i.initials = {
            ...
            dates: {
              ...
              id: {
                ...
                noEventForToday:
                  'Tidak ada festival hari ini...',
                noEventForThisDay: 'Tidak ada festival tanggal ini...',
                previousYearText: 'Tahun sebelumnya',
                nextYearText: 'Tahun berikutnya',
                closeSidebarText: 'Tutup daftar bulan',
                closeEventListText: 'Tutup daftar festival',
              },
              jp: {
                days: [
                  '日曜日',
                ...
                daysMin: ['日曜日','月曜日','火曜日','水曜日','木曜日','金曜日','土曜日'],
                months: [
                  '1月',
                  '2月',
                  '3月',
                ...
                noEventForToday: '今日はイベントはありません...', //'この日はお祭りはありません...',
                noEventForThisDay: 'この日付にはイベントはありません...', //'この日にお祭りはありません...',
                previousYearText: '前年',
                nextYearText: '来年',
                closeSidebarText: '月リストを閉じる',
                closeEventListText: 'イベントリストを閉じる',
              },
              es: {
                days: [
                  'Domingo',
                ...
                noEventForToday:
                  'No hay evento para hoy.. \xA1así que descanse! :)',
                noEventForThisDay:
                  'Ningún evento para este día.. \xA1así que descanse! :)',
        ...
        i.$current = {
          ...
          year:
            isNaN(this.year) || null == this.year
              ...
              : this.year,
          date: i.formatDate(
            i.initials.dates[i.defaults.language].months[new Date().getMonth()] +
              ' ' +
              new Date().getDate() +
              ' ' +
              new Date().getFullYear(),
    ...
    t.prototype.formatDate = function (t, a, n) {
      ...
      var o = new Date(t),
        r = {
          ...
          yyyy: o.getFullYear()
          //yyyy: o.getFullYear() + (i.options.language == 'jp' ? ' 年' : '') ,
        }
      r.dd = (r.d < 10 ? '0' : '') + r.d
      r.mm = (r.m < 10 ? '0' : '') + r.m
      t = []
    ...
    t.prototype.getBetweenDates = function (e) {
      for (var t = this, a = [], n = 0; n < t.monthLength; n++) {
        var i = t.formatDate(
          t.$label.months[t.$active.month] + ' ' + (n + 1) + ' ' + t.$active.year,
          t.options.format
        )
    ...
    t.prototype.resize = function () {
      ...
      i <= t.$breakpoints.tablet && i > t.$breakpoints.mobile
        ...
        ? (a && t.toggleSidebar(false),
          n && t.toggleEventList(false),
      ...
      if ((i.children().length > 0 && i.empty(), t.options.calendarEvents)) {
        for (var o = 0; o < t.options.calendarEvents.length; o++) {
          if (
            ...
            if (t.options.calendarEvents[o].everyYear) {
        ...
        for (var o = 0; o < a.$label.days.length; o++) {
          if (n <= a.monthLength && (i > 0 || o >= a.startingDay)) {
            ...
            e +=
              ...
              a.formatDate(
                a.$label.months[a.$active.month] + ' ' + n + ' ' + a.$active.year,
                a.options.format
              ) +
              '">' +
              n +
    ...
    t.prototype.selectYear = function (t) {
      ...
      o <= i.$breakpoints.mobile && r && i.toggleSidebar(false)
    ...
    t.prototype.selectMonth = function (t) {
      ...
      n <= a.$breakpoints.tablet && i && a.toggleSidebar(false)
    ...
    t.prototype.toggleOutside = function (e) {
      ...
      t && n && i.toggleSidebar(false)
      a && n && i.toggleEventList(false)
    }
